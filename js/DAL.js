...
let userOperations = {
    createDummy: function(){
        database.transaction(function(transaction){
            ...
            let options = ["Jane Doe","doe.jane@gmail.com","XptO$%90"]

            transaction.executeSql(sql, options, successCallback(transaction,"CREATE USER"), errorCallback);
        })
    },
    ...
    update: function(_user){
        database.transaction(function(transaction){
            ...
            transaction.executeSql(sql, options, successCallback(transaction,"UPDATE USER"), errorCallback);
        })
    }
}
